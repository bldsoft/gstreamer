...
GST_VIDEO_API
void                 gst_video_encoder_set_skip_close_force_keyframes (GstVideoEncoder * encoder, gboolean is_skip);

GST_VIDEO_API
gboolean             gst_video_encoder_is_skip_close_force_keyframes (GstVideoEncoder * encoder);
